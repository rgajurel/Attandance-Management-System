...
{
        public static DateTime GetEnglsihTimeToNepaliDateTime(DateTime EnglishDate)
    {
        ...
        DateTime actualnepalidate = TimeZoneInfo.ConvertTimeBySystemTimeZoneId(EnglishDate, TimeZoneInfo.Local.Id, "Nepal Standard Time");
        ...
        DateTime timeofday = TimeZoneInfo.ConvertTimeBySystemTimeZoneId(EnglishDate, TimeZoneInfo.Local.Id, "Nepal Standard Time");

            var datetime= new DateTime(NepaliYear, NepaliMonth, NepaliDay, timeofday.Hour, timeofday.Minute, timeofday.Second);
