var totalPages1 = Math.ceil(parseInt(totalEntranceEntry) / NoofEntrancePerPage);
var IsPageLoaded = 0;
var PageIndex;
var UserCurrentPage;
var IsSearched = 0;
...
$(document).ready(function () {
    ...
    function watchCountdown() {
        ...
        if (parseInt(timeElpased) % 10 == 0 && parseInt(timeElpased) != 0) {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: 'EntranceClient/SetElapsedTime',
                async: true,
    ...
    function GetEntranceListing(pageIndex) {
        var mydata = {
    ...
    function GetDetailsForEntrance(Data) {
        var mydata = {
            CustomData: Data
        };
        $.ajax({
            type: "post",
            dataType: "json",
            url: 'EntranceClient/GetEntranceInformation',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
    ...
    function ProceedEntrance(data, IsFW) {
        if (IsFW) {
            var mydata = {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: 'EntranceClient/EntranceProcced',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
                if (!$.isEmptyObject(data)) {
                    var ErrorJSONObject;
    ...
    function EntranceReport(data) {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: 'EntranceClient/EntranceReport',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
                if (!$.isEmptyObject(data)) {
                    $('body').addClass('quiz-start');
    ...
    function InitaiteEntrance(data) {
        var mydata = {
            CustomData: data,
        };
        $.ajax({
            type: "post",
            dataType: "json",
            url: 'EntranceClient/EntranceStart',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
            }
        });
    ...
    function PauseEntrance(data) {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: 'EntranceClient/PauseEntrance',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
                if (data) {
    ...
    function PreviousQuestion(data) {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: 'EntranceClient/GetPreviousQuestion',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
                if (!$.isEmptyObject(data)) {
    ...
    function NextQuestion(data) {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: 'EntranceClient/GetNextQuestion',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
                if (!$.isEmptyObject(data)) {
                    $('#previousEntry>div.row').remove();
    ...
    function UIEvent() {
        ...
        $('form.quiz-play-form ul.quiz-model>li>a.QuizPlay').off().on('click', function (e) {
            ...
            if (getClass == "first100") {
                ...
                EntranceReport(dataArry);
            }
            else {
                GetDetailsForEntrance(mydata);
            }
            ...
            if (IsFreeWriting.length > 0) {
                if (Mandatory) {
                    if (FreeWritingAnswer.length > 0) {
                        ProceedEntrance(IsFreeWriting.attr('data-val') + ',' + FreeWritingAnswer, true);
                    }
                    else {
                ...
                if (Mandatory) {
                    if (Selected.length > 0) {
                        if (ClassAction.indexOf("QuizNext") > -1) {
                            ...
                            ProceedEntrance(dataArry, false);
                        }
                    }
                    else {
                        $("#PopUpQuestionMandatory").data("kendoWindow").center().open();
