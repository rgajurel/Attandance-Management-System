...
$(document).ready(function () {
    ...
    $("#btnSave").on('click', function (e) {
        if (!$('#formCategory').data('unobtrusiveValidation').validate()) {
            ...
            $.ajax({
                url: '/Admin/QuizQuestionCategory/CategoryTreeSave',
                type: 'POST',
                dataType: 'json',
...
function EditCategory(e) {
    ...
    $.ajax({
        url: '/Admin/QuizQuestionCategory/CategoryTreeInfoByID',
        type: "post",
        dataType: "json",
...
function DeleteCategory(e) {
    ...
    $("button#Yes").off().on('click', function (e) {
        ...
        $.ajax({
            url: '/Admin/QuizQuestionCategory/CategoryTreeDelete',
            type: "post",
            dataType: "json",
            data: AddAntiForgeryToken(data),
            success: function (data) {
...
function LoadParentDropDown() {
    ...
    $.ajax({
        url: '/Admin/QuizQuestionCategory/GetAllActiveParentForAdmin',
        type: "post",
        dataType: "json",
