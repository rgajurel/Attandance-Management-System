...
function ParamToLoadQuizUserReportList(e) {
    ...
    var objInfo1 =
   {
       SearchQuizName: $('#txtSearchQuizTitle').val(),
       ...
       SearchQuizStatus: $("#ddlSearchQuizStatus :selected").val(),
...
function AssignMarkToUserAnswer(UserScore,ID)
{
    ...
    $.ajax({
        type: "post",
        dataType: "json",
        url: 'QuizUserReport/AssignMarksToUser',
...
function QuizUserDetail(e) {
    ...
    $.ajax({
        type: "post",
        dataType: "json",
        url: 'QuizUserReport/GetUserQuizAnswerByUserID',
        data: AddAntiForgeryToken(mydata),
        success: function (data) {
            if (data.success == "200") {
                ...
                $("#DescQuizTitle").html('').html(trimQuizTitle(dataItem.QuizTitle));
                ...
                $("#MarkSheetQuizTitle").html('').html(trimQuizTitle(dataItem.QuizTitle));
                var html = "";
