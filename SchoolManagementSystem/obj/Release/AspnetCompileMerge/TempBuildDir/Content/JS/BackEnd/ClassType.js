...
{  
    ...
    else
    {
        ...
        $.ajax({
            url: "/Admin/ClassType/SaveClassType",
            type: 'POST',
            ...
            success: function (data)
            {
                ...
                $("#ClassTypeGrid").data("kendoGrid").dataSource.read();
                $("#hide").hide();
                $("#show").fadeIn(500);
...
$("#FieldFilter").keyup(function ()
{
    ...
    grid = $("#ClassTypeGrid").data("kendoGrid");
    rowNumber = 0;
    if (value)
    {
...
function Edit(e)
{
    ...
    $.ajax({
        url: "/Admin/ClassType/EditClassType",
        data: { id: dataItem.ID },
        type: "POST",
        dataType: "json",
...
function Delete(e) {
    ...
    $("#yes").off().on('click', function (e) {
        ...
        $.ajax({
            url: "/Admin/ClassType/DeleteClassType",
            data: { id: dataItem.ID },
            type: 'POST',
            dataType: 'json',
            success: function (result)
