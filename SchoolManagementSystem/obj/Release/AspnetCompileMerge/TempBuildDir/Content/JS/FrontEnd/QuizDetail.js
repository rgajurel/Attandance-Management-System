...
$(document).ready(function () {
    ...
    function GetDetailsForQuiz(Data) {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: '/QuizDetail/GetQuizInformation',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
    ...
    function PreviousQuestion(data) {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: '/QuizDetail/GetPreviousQuestion',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
                if (!$.isEmptyObject(data)) {
    ...
    function NextQuestion(data) {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: '/QuizDetail/GetNextQuestion',
            data: AddAntiForgeryToken(mydata),
            success: function (data) {
                if (!$.isEmptyObject(data)) {
                    $('#previousEntry>div.row').remove();
